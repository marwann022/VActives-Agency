      ...
      <BaseContainer class="contact-grid">
        <div class="contact-copy">
          ...
          <div class="contact-details">
            <a :href="`mailto:${siteDetails.email}`"><IconMail :size="21" /><span><small>Email us</small>{{ siteDetails.email }}</span></a>
            <div><IconClock :size="21" /><span><small>Business hours</small>{{ siteDetails.hours }}</span></div>
          </div>
        </div>
...
@media(max-width:767px){.contact-page :deep(.max-w-container){padding-left:20px!important;padding-right:20px!important}}
</style>
