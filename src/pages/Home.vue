...
const roleOptions = [
  ...
  { label: 'Virtual Assistant', value: 'Virtual Assistant', badge: 'Ops support' },
  { label: 'Customer Service Representative', value: 'Customer Service Representative', badge: 'Client care' },
