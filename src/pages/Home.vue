      ...
      <BaseContainer class="hero-grid">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            ...
            <a class="outline-button magnetic-button" href="#contact">Contact Us</a>
          </div>
      ...
      <BaseContainer>
        <div class="hire-panel">
          ...
          <form class="hire-form" @submit.prevent="submitForm">
            ...
            <label>Role needed<select v-model="form.role" required><option disabled value="">Select a role</option><option v-for="role in roleOptions" :key="role">{{ role }}</option></select></label>
...
import { IconArrowRight, IconArrowUpRight, IconCheck } from '@tabler/icons-vue'
